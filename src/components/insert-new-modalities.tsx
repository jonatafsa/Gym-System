...
export default function InsertNewModalitie() {
  ...
  function registerNewModalitie(e: FormEvent) {
    ...
    const dbStaffRef = ref(
      db,
      "gym_users/" + user?.uid + "/staff/" + responsibleDoc
    );
    ...
    set(dbRef, {
      ...
      update(dbStaffRef, {
        ...
        modalToggle()
        toast.success("Modalidade inserida com sucesso!!")
      })
    });
  }
      ...
      <form onSubmit={registerNewModalitie}>
        <div className="form-container">
          ...
          <div>
            ...
            <button className="btn" type="button" onClick={insertNewTime}>
              Inserir
            </button>
          </div>
